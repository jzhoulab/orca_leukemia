...
if variant == 'INV':
    ...
    res = process_inv(chrm.replace('chr',''), start, end, 
                      hg19, target=False, custom_models=[leuA, leuB],
...
if variant == 'TL':
    ...
    chrm2 = sys.argv[4]
    pos2 = int(sys.argv[5])
    strand1, strand2 = sys.argv[6]
    res = process_single_breakpoint(chrm1.replace('chr',''), pos1, chrm2.replace('chr',''), pos2, strand1, strand2,
                      hg19, target=False, custom_models=[leuA, leuB],
                     model_labels=['T-ALL (GSE134761)','THP1', 'GM12878', 'NALM6', 'Non-ETP (GSE146901)','ETP (GSE146901)', 'K562', 'KBM7'])
...
if variant == 'DEL':
    ...
    res = process_del(chrm.replace('chr',''), start, end, 
                      hg19, target=False, custom_models=[leuA, leuB],
                     model_labels=['T-ALL (GSE134761)','THP1', 'GM12878', 'NALM6', 'Non-ETP (GSE146901)','ETP (GSE146901)', 'K562', 'KBM7'])
...
if variant == 'DUP':
    ...
    res = process_dup(chrm.replace('chr',''), start, end, 
                      hg19, target=False, custom_models=[leuA, leuB],
                     model_labels=['T-ALL (GSE134761)','THP1', 'GM12878', 'NALM6', 'Non-ETP (GSE146901)','ETP (GSE146901)', 'K562', 'KBM7'])

torch.save(res, 'prediction.pth')
